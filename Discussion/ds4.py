# CS 1210, Spring 2019.
# Discussion section 4, Feb. 12 and 13
...
#
# 6. Now try anagramInfo("wordsMany.txt") again.
#         Try on whatever words you want. Some suggestions: art, stop, spear, least
# 7. Like steps 4 and 5, implement now implement areNeighbors and getNeighborsOf.
